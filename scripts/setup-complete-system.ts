...
const ordersCount = parseInt(
  args.find(arg => arg.startsWith("--orders="))?.split("=")[1] || "500"
);
  ...
  const productData = [
    ...
    },
    {
      ...
      name: {
        ...
        ru: "Молочный чай с коричневым сахаром",
        zh: "黑糖奶茶",
      },
      categoryId: 1,
    },
    {
      code: "FRUIT_TEA_001",
      name: {
        en: "Strawberry Fruit Tea",
        ru: "Клубничный фруктовый чай",
        zh: "草莓果茶",
      },
      categoryId: 2,
    },
    ...
    {
      code: "GREEN_TEA_002",
      name: { en: "Matcha Latte", ru: "Латте с матча", zh: "抹茶拿铁" },
      categoryId: 3,
    },
    {
      code: "SNACK_001",
      name: { en: "Cheese Cake", ru: "Чизкейк", zh: "芝士蛋糕" },
      categoryId: 4,
    },
    {
      code: "SNACK_002",
      name: { en: "Egg Tart", ru: "Яичный тарт", zh: "蛋挞" },
      categoryId: 4,
    },
    {
      code: "COFFEE_001",
      name: { en: "Americano", ru: "Американо", zh: "美式咖啡" },
      categoryId: 5,
    },
  ];
