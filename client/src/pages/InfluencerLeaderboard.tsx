        ...
        <div className="flex items-end justify-center gap-4">
          ...
          <div className="flex flex-col items-center flex-1">
            ...
            <div className="text-white font-bold text-sm mb-2">
              {formatCurrency(MOCK_LEADERBOARD[1].earnings)}
            </div>
          ...
          <div className="flex flex-col items-center flex-1 -mt-4">
            ...
            <div className="text-white font-bold mb-2">
              {formatCurrency(MOCK_LEADERBOARD[0].earnings)}
            </div>
          ...
          <div className="flex flex-col items-center flex-1">
            ...
            <div className="text-white font-bold text-sm mb-2">
              {formatCurrency(MOCK_LEADERBOARD[2].earnings)}
            </div>
            ...
            return (
              <div
                ...
                className={`p-4 flex items-center gap-4 ${
                  index !== MOCK_LEADERBOARD.slice(3).length - 1
              ...
              >
                {/* Rank Badge */}
                <div
                  className={`w-10 h-10 rounded-full ${badge.color} flex items-center justify-center font-bold ${badge.text} flex-shrink-0`}
                >
                  {badge.icon}
                </div>
