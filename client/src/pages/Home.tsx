              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-bold text-sm">
                    {t("pages_home_chutea_会员俱乐部")}
                  </div>
                  <p className="text-[10px] text-white/60 mt-0.5">
                    {t("pages_home_立即加入_首单享_5_折优惠")}
                  </p>
                </div>
              </div>
              <Button
                size="sm"
                variant="outline"
                className="bg-white text-black border-none hover:bg-gray-200 rounded-full h-8 text-xs font-bold px-4"
              >
                {t("pages_home_加入")}
              </Button>
            </div>
