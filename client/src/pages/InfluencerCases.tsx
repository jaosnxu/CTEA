...
import { ChevronLeft, Heart, MessageCircle, Share2, TrendingUp } from "lucide-react";
...
const MOCK_CASES = [
  {
    ...
    story: "Делясь качественными продуктами и опытом обслуживания CHUTEA в социальных сетях, я успешно пригласил 245 друзей. Главное - искренне делиться, чтобы друзья почувствовали ценность бренда.",
    tips: ["Выберите подходящую социальную платформу", "Делитесь реальным опытом использования", "Регулярно публикуйте качественный контент", "Активно взаимодействуйте с подписчиками"],
  ...
  },
  {
    ...
    story: "Мой секрет - создание собственного сообщества любителей чая, регулярная организация офлайн-дегустаций. Личное общение даёт высокую конверсию.",
    tips: ["Создайте эксклюзивное сообщество", "Организуйте офлайн-мероприятия", "Давайте профессиональные советы", "Создайте личный бренд"],
  ...
  },
  {
    ...
    story: "Как фуд-блогер, я интегрирую CHUTEA в повседневный контент. Красивые фото и видео привлекают много подписчиков.",
    tips: ["Создавайте качественный контент", "Поддерживайте частоту публикаций", "Используйте визуальный маркетинг", "Завоёвывайте доверие подписчиков"],
  ...
  },
  {
    ...
    story: "Я фокусируюсь на корпоративных клиентах, предоставляя услуги CHUTEA для тимбилдингов и конференций. B2B модель делает продвижение эффективнее.",
    tips: ["Развивайте корпоративных клиентов", "Предлагайте индивидуальные услуги", "Стройте долгосрочное сотрудничество", "Сарафанное радио"],
  ...
  },
  {
    ...
    story: "Используя трафик коротких видео, я создал серию обзоров и креативных рецептов CHUTEA, быстро набрав подписчиков.",
    tips: ["Используйте преимущества платформы", "Создавайте креативный контент", "Оптимизируйте через аналитику", "Постоянно учитесь и развивайтесь"],
    ...
    <div className="min-h-screen bg-gray-50 max-w-md mx-auto shadow-2xl relative flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div key={caseItem.id} className="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="px-4 pb-4">
              <div className="bg-gradient-to-r from-teal-50 to-blue-50 rounded-lg p-3 grid grid-cols-3 gap-2">
                <div className="text-center">
                  <div className="text-lg font-bold text-teal-600">{caseItem.achievement.referrals}</div>
                  <div className="text-xs text-gray-600">邀请человек数</div>
                </div>
                <div className="text-center">
                  <div className="text-lg font-bold text-teal-600">{formatCurrency(caseItem.achievement.earnings)}</div>
                  <div className="text-xs text-gray-600">累计收益</div>
                </div>
                <div className="text-center">
                  <div className="text-lg font-bold text-teal-600">{caseItem.achievement.period}</div>
            ...
            <div className="px-4 py-3 border-t border-gray-100 flex items-center justify-between">
              ...
              >
                <Heart 
                  size={18} 
                  className={likedCases.includes(caseItem.id) ? "fill-red-500 text-red-500" : ""}
                />
                <span className="text-sm">{caseItem.likes + (likedCases.includes(caseItem.id) ? 1 : 0)}</span>
              </button>
        ...
        <div className="bg-gradient-to-br from-teal-500 to-teal-700 rounded-xl p-6 text-white text-center">
          <h3 className="text-xl font-bold mb-2">你也可以成为Отличный инфлюенсер</h3>
