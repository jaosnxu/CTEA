...
export default function ProductDetail() {
  ...
  const [activeTab, setActiveTab] = useState<"intro" | "nutrition" | "reviews">("intro");
    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="bg-white mt-2 px-4 py-4">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-sm text-gray-400">|</span>
          <span className="text-sm text-gray-600">{product.likes} человек喜欢</span>
        </div>
        <div className="text-primary font-bold text-3xl">{formatCurrency(product.price)}</div>
      </div>
                ...
                <>
                  ...
                  <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-2xl p-6 shadow-sm">
                    <div className="flex items-center justify-around">
                      ...
                      <div className="text-center">
                        <div className="text-4xl font-bold text-gray-800 mb-1">{productReviews.length}</div>
                  ...
                  {allReviewImages.length > 0 && (
                    <div>
                      <h3 className="font-bold text-base mb-3 flex items-center gap-2">
                        <span>用户Фото</span>
                        <span className="text-sm text-gray-400 font-normal">({allReviewImages.length})</span>
                      </h3>
                        ...
                        <div key={review.id} className="bg-white rounded-xl p-4 shadow-sm">
                          <div className="flex items-start gap-3 mb-3">
                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-orange-400 to-pink-400 flex items-center justify-center flex-shrink-0">
                              <span className="text-white text-sm font-bold">{String.fromCharCode(65 + (index % 26))}</span>
                            </div>
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2 mb-1">
                                <span className="text-sm font-bold text-gray-800">用户{String.fromCharCode(65 + (index % 26))}</span>
      ...
      <ProductSpecModal
        ...
        product={{
          ...
          sweetness: ["Стандарт", "Меньше", "Половина", "Немного сахара", "Без сахара"],
          toppings: [
