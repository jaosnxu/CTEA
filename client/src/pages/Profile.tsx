...
export default function Profile() {
  ...
  const menuItems = [
    {
      title: t("pages_profile_我的优惠券"),
      icon: Gift,
      path: "/coupons",
      badge: t("pages_profile_3张可用"),
    },
    {
      title: t("pages_profile_我的礼品卡"),
      icon: CreditCard,
      path: "/gift-cards",
      badge: "",
    },
    {
      title: t("pages_profile_活动中心"),
      icon: PartyPopper,
      path: "/activity-center",
      badge: t("pages_profile_新"),
    },
    {
      title: t("pages_profile_会员中心"),
      icon: Star,
      path: "/membership",
      badge: t(`member_level_${userProfile.level}`),
    },
    {
      title: t("pages_profile_我的收藏"),
      icon: Heart,
      path: "/favorites",
      badge: "",
    },
    {
      title: t("pages_profile_我的地址"),
      icon: MapPin,
      path: "/addresses",
      badge: "",
    },
    {
      title: t("pages_profile_达人中心"),
      icon: ShieldCheck,
      path: "/influencer",
      badge: "",
    },
    {
      title: t("pages_profile_设置"),
      icon: Settings,
      path: "/settings",
      badge: "",
    },
