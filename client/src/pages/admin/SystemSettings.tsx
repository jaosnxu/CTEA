...
export default function SystemSettings() {
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      const configsToSave = Object.entries(localConfigs).map(
        ([key, value]) => ({
          key,
          value,
        })
      ...
      <aside className="w-64 bg-white border-r border-gray-200 min-h-screen">
        <div className="p-6">
          ...
          <nav className="space-y-1">
            ...
            <a
              href="/admin/settings"
              className="flex items-center gap-3 px-4 py-3 bg-amber-50 text-amber-700 rounded-xl font-medium"
            >
              <Settings className="w-5 h-5" />
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-gray-800">
                    {t.notifyConfig.newRegistration}
                  </span>
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-gray-800">
                    {t.notifyConfig.withdrawRequest}
                  </span>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                ...
                <div className="p-4 bg-gray-50 rounded-xl">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-gray-600">
                      {t.captchaStatus.todayUsage}
                    </span>
                    <span className="text-xl font-bold text-gray-900">
                      {captchaStatus.todayUsage}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${(captchaStatus.monthUsage / captchaStatus.monthLimit) * 100}%`,
                      }}
                    />
                  </div>
