...
export default function SDUIConfigPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "membership" | "theme" | "banners" | "features"
  >("membership");
    ...
    <AdminLayout>
      <div className="p-6">
        ...
        <div className="flex gap-2 mb-6 border-b">
          {(["membership", "theme", "banners", "features"] as const).map(
            tab => (
              <button
                key={tab}
