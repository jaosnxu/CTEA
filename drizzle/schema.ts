...
export const auditLogs = mysqlTable(
  "audit_logs",
  {
    ...
    operatorType: mysqlEnum("operator_type", [
      "ADMIN",
      "USER",
      "SYSTEM",
      "API",
...
export const systemConfigs = mysqlTable(
  ...
  table => ({
    keyIdx: uniqueIndex("config_key_idx").on(
      table.orgId,
      table.storeId,
      table.configKey
    ),
 ...
 * 权限规则表
 */
export const permissionRules = mysqlTable(
  "permission_rules",
  {
    id: int("id").autoincrement().primaryKey(),
 ...
 * 虚拟保证金账户表
 */
export const depositAccounts = mysqlTable(
  "deposit_accounts",
  {
    id: int("id").autoincrement().primaryKey(),
    ...
    frozenAmount: decimal("frozen_amount", { precision: 15, scale: 2 }).default(
      "0.00"
    ), // 冻结金额
    currency: varchar("currency", { length: 10 }).default("RUB"),
    status: mysqlEnum("status", ["ACTIVE", "FROZEN", "CLOSED"]).default(
      "ACTIVE"
    ),
    createdAt: timestamp("created_at").defaultNow().notNull(),
    updatedAt: timestamp("updated_at").defaultNow().onUpdateNow().notNull(),
  ...
  table => ({
    ...
    storeIdx: uniqueIndex("deposit_store_idx").on(
      table.storeId,
      table.accountType
    ),
  })
...
export const settlementRules = mysqlTable("settlement_rules", {
  ...
  autoRefundThreshold: decimal("auto_refund_threshold", {
    precision: 5,
    scale: 2,
  }).default("0.30"), // 超额退回阈值 30%
  settlementCycle: mysqlEnum("settlement_cycle", [
    "DAILY",
    "WEEKLY",
    "MONTHLY",
  ]).default("WEEKLY"),
 ...
 * 跨店对账表 - A店发券B店核销
 */
export const crossStoreLedger = mysqlTable(
  "cross_store_ledger",
  {
    id: bigint("id", { mode: "number" }).autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
    ...
    settlementStatus: mysqlEnum("settlement_status", [
      "PENDING",
      "PROCESSING",
      "SETTLED",
      "CANCELLED",
...
export const settlementBatches = mysqlTable(
  "settlement_batches",
  {
    ...
    netAmount: decimal("net_amount", { precision: 15, scale: 2 }).default(
      "0.00"
    ), // 轧差后净额
 ...
 * 退款记录表
 */
export const refundRecords = mysqlTable(
  "refund_records",
  {
    id: bigint("id", { mode: "number" }).autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
    ...
    refundType: mysqlEnum("refund_type", [
      "FULL",
      "PARTIAL",
      "AUTO_EXCESS",
    ]).notNull(), // AUTO_EXCESS = 超额自动退回
...
export const financialReports = mysqlTable(
  "financial_reports",
  {
    ...
    netRevenue: decimal("net_revenue", { precision: 15, scale: 2 }).default(
      "0.00"
    ),
    ...
    generatedBy: mysqlEnum("generated_by", ["SYSTEM", "AI", "MANUAL"]).default(
      "SYSTEM"
    ),
    createdAt: timestamp("created_at").defaultNow().notNull(),
  },
...
export const campaigns = mysqlTable(
  "campaigns",
  {
    ...
    usedBudget: decimal("used_budget", { precision: 15, scale: 2 }).default(
      "0.00"
    ),
...
export const coupons = mysqlTable(
  "coupons",
  {
    ...
    name: json("name").notNull(), // 多语言名称
    description: json("description"), // 多语言描述
    couponType: mysqlEnum("coupon_type", [
      "FIXED",
      "PERCENT",
      "GIFT",
      "FREE_ITEM",
 ...
 * 用户优惠券表
 */
export const userCoupons = mysqlTable(
  "user_coupons",
  {
    id: int("id").autoincrement().primaryKey(),
 ...
 * SDUI 动态布局表
 */
export const sduiLayouts = mysqlTable(
  "sdui_layouts",
  {
    id: int("id").autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
    ...
    layoutType: mysqlEnum("layout_type", [
      "HOME",
      "MENU",
      "PROMOTION",
      "BANNER",
    ...
    status: mysqlEnum("status", ["DRAFT", "ACTIVE", "INACTIVE"]).default(
      "DRAFT"
    ),
 ...
 * 地理围栏规则表
 */
export const geoFenceRules = mysqlTable(
  "geo_fence_rules",
  {
    id: int("id").autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
 ...
 * 天气触发规则表
 */
export const weatherTriggers = mysqlTable(
  "weather_triggers",
  {
    id: int("id").autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
 ...
 * SKU 属性定义表 - 原子化配置
 */
export const skuAttributes = mysqlTable(
  "sku_attributes",
  {
    id: int("id").autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
    ...
    name: json("name").notNull(), // 多语言名称
    attributeType: mysqlEnum("attribute_type", ["SINGLE", "MULTIPLE"]).default(
      "SINGLE"
    ), // 单选/多选
  ...
  table => ({
    ...
    codeIdx: uniqueIndex("sku_attr_code_idx").on(
      table.orgId,
      table.attributeCode
    ),
  })
...
export const productSkus = mysqlTable(
  "product_skus",
  {
    ...
    priceAdjust: decimal("price_adjust", { precision: 15, scale: 2 }).default(
      "0.00"
    ),
 ...
 * 门店价格表 - 支持门店级别定价
 */
export const storePrices = mysqlTable(
  "store_prices",
  {
    id: int("id").autoincrement().primaryKey(),
    storeId: int("store_id").notNull(),
 ...
 * 分时段菜单表 - 支持 11 个时区
 */
export const timeSlotMenus = mysqlTable(
  "time_slot_menus",
  {
    id: int("id").autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
 ...
 * iiko 影子菜单表 - 价格熔断机制
 */
export const iikoShadowMenu = mysqlTable(
  "iiko_shadow_menu",
  {
    id: int("id").autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
 ...
 * 价格变更日志表
 */
export const priceChangeLogs = mysqlTable(
  "price_change_logs",
  {
    id: bigint("id", { mode: "number" }).autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
 ...
 * 数据流水线表
 */
export const dataPipelines = mysqlTable(
  "data_pipelines",
  {
    id: int("id").autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
    ...
    name: json("name").notNull(), // 多语言名称
    pipelineType: mysqlEnum("pipeline_type", [
      "ETL",
      "REPORT",
      "ANALYSIS",
      "TRANSLATION",
    ...
    lastRunStatus: mysqlEnum("last_run_status", [
      "SUCCESS",
      "FAILED",
      "RUNNING",
    ]),
 ...
 * 翻译审核表 - A+B 审核流
 */
export const translationReviews = mysqlTable(
  "translation_reviews",
  {
    id: int("id").autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
 ...
 * 向量嵌入表 - Vector DB
 */
export const vectorEmbeddings = mysqlTable(
  "vector_embeddings",
  {
    id: bigint("id", { mode: "number" }).autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
...
export const orders = mysqlTable(
  "orders",
  {
    ...
    deliveryFee: decimal("delivery_fee", { precision: 15, scale: 2 }).default(
      "0.00"
    ),
 ...
 * 订单优惠记录表
 */
export const orderDiscounts = mysqlTable(
  "order_discounts",
  {
    id: int("id").autoincrement().primaryKey(),
    orderId: bigint("order_id", { mode: "number" }).notNull(),
...
export const reviews = mysqlTable(
  "reviews",
  {
    ...
    status: mysqlEnum("status", ["PENDING", "PUBLISHED", "HIDDEN"]).default(
      "PENDING"
    ),
    createdAt: timestamp("created_at").defaultNow().notNull(),
    updatedAt: timestamp("updated_at").defaultNow().onUpdateNow().notNull(),
 ...
 * 评价图片表
 */
export const reviewImages = mysqlTable(
  "review_images",
  {
    id: int("id").autoincrement().primaryKey(),
 ...
 * 购物中心商品表
 */
export const mallProducts = mysqlTable(
  "mall_products",
  {
    id: int("id").autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
 ...
 * 购物中心订单表
 */
export const mallOrders = mysqlTable(
  "mall_orders",
  {
    id: bigint("id", { mode: "number" }).autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
    ...
    subtotal: decimal("subtotal", { precision: 15, scale: 2 }).notNull(),
    shippingFee: decimal("shipping_fee", { precision: 15, scale: 2 }).default(
      "0.00"
    ),
    discountAmount: decimal("discount_amount", {
      precision: 15,
 ...
 * 购物中心订单明细表
 */
export const mallOrderItems = mysqlTable(
  "mall_order_items",
  {
    id: bigint("id", { mode: "number" }).autoincrement().primaryKey(),
    orderId: bigint("order_id", { mode: "number" }).notNull(),
 ...
 * 购物中心库存表
 */
export const mallInventory = mysqlTable(
  "mall_inventory",
  {
    id: int("id").autoincrement().primaryKey(),
    productId: int("product_id").notNull(),
  ...
  table => ({
    productIdx: uniqueIndex("inventory_product_idx").on(
      table.productId,
      table.warehouseId
    ),
  })
 ...
 * 物流追踪表
 */
export const logisticsTracking = mysqlTable(
  "logistics_tracking",
  {
    id: bigint("id", { mode: "number" }).autoincrement().primaryKey(),
    orderId: bigint("order_id", { mode: "number" }).notNull(),
 ...
 * 达人表
 */
export const influencers = mysqlTable(
  "influencers",
  {
    id: int("id").autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
    ...
    level: mysqlEnum("level", ["BRONZE", "SILVER", "GOLD", "PLATINUM"]).default(
      "BRONZE"
    ),
    ...
    status: mysqlEnum("status", ["PENDING", "ACTIVE", "SUSPENDED"]).default(
      "PENDING"
    ),
    createdAt: timestamp("created_at").defaultNow().notNull(),
    updatedAt: timestamp("updated_at").defaultNow().onUpdateNow().notNull(),
 ...
 * 达人任务表
 */
export const influencerTasks = mysqlTable(
  "influencer_tasks",
  {
    id: int("id").autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
 ...
 * 达人佣金表
 */
export const influencerCommissions = mysqlTable(
...
export const chatSessions = mysqlTable(
  "chat_sessions",
  {
    ...
    status: mysqlEnum("status", ["ACTIVE", "CLOSED", "TRANSFERRED"]).default(
      "ACTIVE"
    ),
 ...
 * Telegram Bot 配置表
 */
export const telegramBotConfig = mysqlTable(
  "telegram_bot_config",
  {
    id: int("id").autoincrement().primaryKey(),
    orgId: int("org_id").notNull(),
...
export const users = mysqlTable(
  "users",
  {
    ...
    memberLevel: mysqlEnum("member_level", [
      "NORMAL",
      "SILVER",
      "GOLD",
      "PLATINUM",
    ...
    withdrawableBalance: decimal("withdrawable_balance", {
      precision: 10,
      scale: 2,
    }).default("0.00"), // 可提现余额
...
export const userAddresses = mysqlTable(
  "user_addresses",
  {
    id: int("id").autoincrement().primaryKey(),
    userId: int("user_id").notNull(),
    addressType: mysqlEnum("address_type", ["HOME", "WORK", "OTHER"]).default(
      "HOME"
    ),
...
export const userPoints = mysqlTable(
  "user_points",
  {
    id: bigint("id", { mode: "number" }).autoincrement().primaryKey(),
    userId: int("user_id").notNull(),
    pointType: mysqlEnum("point_type", [
      "EARN",
      "REDEEM",
      "EXPIRE",
      "ADJUST",
...
export const giftCards = mysqlTable(
  "gift_cards",
  {
    ...
    initialValue: decimal("initial_value", {
      precision: 15,
      scale: 2,
    }).notNull(),
 ...
 * SMS 验证码日志表
 */
export const smsVerificationLogs = mysqlTable(
 ...
 * 手机号绑定记录表
 */
export const phoneBindings = mysqlTable(
  "phone_bindings",
  {
    id: int("id").autoincrement().primaryKey(),
    userId: int("user_id").notNull(),
    ...
    bindingSource: mysqlEnum("binding_source", [
      "SELF",
      "HQ_CREATE",
      "FRANCHISEE_CREATE",
    ]).default("SELF"),
 ...
 * 敏感动作日志表
 */
export const sensitiveActionLogs = mysqlTable(
 ...
 * 安全令牌表
 */
export const securityTokens = mysqlTable(
  "security_tokens",
  {
    id: int("id").autoincrement().primaryKey(),
    adminUserId: int("admin_user_id").notNull(),
 ...
 * 核验规则配置表
 */
export const verificationRules = mysqlTable(
  "verification_rules",
  {
    id: int("id").autoincrement().primaryKey(),
 ...
 * 风控日志表
 */
export const riskControlLogs = mysqlTable(
  "risk_control_logs",
  {
    id: bigint("id", { mode: "number" }).autoincrement().primaryKey(),
...
export const captchaConfigs = mysqlTable("captcha_configs", {
  ...
  captchaType: mysqlEnum("captcha_type", ["SLIDE", "CLICK", "SMART"]).default(
    "SLIDE"
  ),
 ...
 * 验证码校验日志表
 */
export const captchaVerifyLogs = mysqlTable(
  "captcha_verify_logs",
  {
    id: bigint("id", { mode: "number" }).autoincrement().primaryKey(),
    ...
    verifyResult: mysqlEnum("verify_result", [
      "PASS",
      "FAIL",
      "ERROR",
    ]).notNull(),
 ...
 * 安全规则配置表
 */
export const securityRules = mysqlTable(
  "security_rules",
  {
    id: int("id").autoincrement().primaryKey(),
    ruleCode: varchar("rule_code", { length: 50 }).notNull().unique(),
 ...
 * 封禁记录表
 */
export const blockedEntities = mysqlTable(
  "blocked_entities",
  {
    id: int("id").autoincrement().primaryKey(),
  ...
  table => ({
    entityIdx: index("blocked_entity_idx").on(
      table.entityType,
      table.entityValue
    ),
...
export const translations = mysqlTable("translations", {
  ...
  isPublished: mysqlEnum("is_published", ["true", "false"])
    .notNull()
    .default("false"),
 ...
 */
export const offlineRedemptionQueue = mysqlTable(
  "offline_redemption_queue",
  {
    id: bigint("id", { mode: "number" }).autoincrement().primaryKey(),
    ...
    redemptionAmount: decimal("redemption_amount", {
      precision: 15,
      scale: 2,
    }).notNull(),
  ...
  table => ({
    ...
    localTimestampIdx: index("offline_local_timestamp_idx").on(
...
export type InsertOfflineRedemptionQueue =
  typeof offlineRedemptionQueue.$inferInsert;
